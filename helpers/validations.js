...
export const validationEmail = (input, setError) => {
    ...
    if (!email.match(regex)) {
        setError({ boolean: true, type: "email", message: "Introduce un email valido" });
        return false;
    }
    ...
    if (subject === "" || subject === null) {
        setError({ boolean: true, type: "subject", message: "Debes introducir un asunto" });
        return false;
    }
    ...
    if (message === "" || message === null) {
        setError({ boolean: true, type: "message", message: "Debes introducir un mensaje" });
        console.log("error");
        return false;
    }
    return true;
